          ...
          <div className="space-y-3">
            {items.map((r, i) => (
              <div key={i} className="flex items-center justify-between py-3 px-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition text-sm">
                <div className="flex-1 font-mono text-gray-700" style={{ fontSize: '0.875rem', fontStyle: 'italic' }}>
                ...
                <div className="flex items-center gap-3">
                  <button
                    onClick={() => window.open(`https://www.google.com/search?q=site:linkedin.com/in+${r.first_name}+${r.last_name}`, "_blank")}

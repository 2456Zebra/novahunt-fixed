...
const mockCompanies = {
  "coca-cola.com": { name: "The Coca-Cola Company", logo: "https://upload.wikimedia.org/wikipedia/commons/thumb/2/25/Coca-Cola_logo_2016.svg/2000px-Coca-Cola_logo_2016.svg.png", founded: "1892", location: "Atlanta, Georgia", size: "10,001+ employees", industry: "Food & Beverages", narrative: "Fizzing since 1886. Secret formula in a vault. Polar bears love it." },
  ...
  "nfl.com": { name: "National Football League", logo: "https://upload.wikimedia.org/wikipedia/en/thumb/a/a0/National_Football_League_logo.svg/1200px-National_Football_League_logo.svg.png", founded: "1920", location: "New York, NY", size: "1,001–5,000 employees", industry: "Sports", narrative: "Where grown men chase a ball for billions on Sundays." },
};
    ...
    <main className="min-h-screen px-8 py-12 max-w-screen-2xl mx-auto">
      <div className="flex items-start justify-between mb-12">
        ...
        <div className="flex items-center gap-8 text-sm font-medium">
          ...
          <a href="/signup" className="hover:underline underline-offset-4 text-blue-500 font-semibold">Sign Up</a>
        </div>
      </div>
      ...
      <div className="flex gap-8">
        ...
        <div className="flex-1 max-w-5xl">
          {company ? (
            ...
            <div className="text-center py-32 text-xl text-gray-500">Click any test domain to see magic →</div>
          )}
        </div>
      </div>
    </main>
